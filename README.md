...
## Возможности кода
Представленный код позволяет реализовать поиск новостей на популярном сайте banki.ru, выделение наиболее интересных новостей и только в интересующей тематике (в представленной версии - в отношении новостей о вкладах) и их публикацию в telegram боте по запросу пользователя. 
